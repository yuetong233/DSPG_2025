...
# 0. What is Remote Sensing {.unnumbered}
...
# 2. Core Components of Google Earth Engine Operations {.unnumbered}
...
#### Core Data Structures in GEE {.unnumbered}
...
## 2.1 Images and Image Collections {.unnumbered}
...
### Sensed versus Derived Imagery {.unnumbered}
...
## 2.3 Features and Boundries {.unnumbered}
...
#### Combine the Pixels within A Certain Boundary {.unnumbered}
...
## 2.5 Methods: Reducers and Joins {.unnumbered}
...
# 3. Physical Bases of Remote Sensing {.unnumbered}

## Four Types of Resolution {.unnumbered}

-   Spatial resolution: The size of the smallest object that can be detected (i.e., pixel size). 
![Spatial resolutions](../figures/Spatial.png)
...
# 4. Time Series Plots {.unnumbered}
...
### Agriculture Phenology {.unnumbered}
...
### Export Data as a CSV File to Google Drive {.unnumbered}
...
# 5. Raster Images v.s. Vector Images {.unnumbered}

### Brief Summary {.unnumbered}
...
### Analytical Capability {.unnumbered}
...
# 6. Find a Suitable Remote Sensing Data {.unnumbered}
...
-  **Data Quality**: reported noise, cloud issues, or atmospheric interference, published accuracy
assessment? Check preprocessing and accessibility in Literature
...
# Optional: Set GEE API through RStudio {.unnumbered}

### O.1. Set Python environment in terminal {.unnumbered}
...
### O.2. Connect RStudio with existing python environment {.unnumbered}
...
### O.3. Set Google drive {.unnumbered}
...
### O.4. To run GEE in the desired python path {.unnumbered}
...
### O.5. Use rgee inside Shiny apps {.unnumbered}
...
### O.6. Connect GEE data with NASS data {.unnumbered}
...
### O.7. Connect GEE data with ACS data {.unnumbered}
